...
def run_analysis(job):
    ...
    if not os.path.exists(job.path + '/0_preprocess/protofibril.pdb'):
        ...
        try:
            ...
            smaller_trajs = [
                '64252120eeb69483e074e3271c1c8e42',
                "f3a5c0c2b57dd0c78fe3a0abd5c052ed",
                "74989c9005dd09e2fa35288d06ae06d7",
                "ab42ac7474e15c28fb7d624920df3a43",
                "e6677aa8dafb085911a73d30ef26e76b",
                "e92eff6f139d6c246e5da1faf3c8b1fd",
                "e29fc7b7e29d683d36286bf7cb490143",
                "45724f8d785c4e8bce93336ee8e88275",
                "1bc8fa8ce6fda7d223fb05029b8e1a60",
            ]
            if job.id in smaller_trajs:
                E, yield_point = estimate_elastic_modulus(stress, strain, window_size = 200)
            else:
